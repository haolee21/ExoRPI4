...
class PlotJointWindow(QWidget):
    ...
    def UpdateData(self,data):
        ...
        self.l_hipData.append(int.from_bytes(data[0:2],'little')*0.087890625)

        self.left_hip_line.setData(self.l_hipData)
        self.l_kneeData.popleft()
        self.l_kneeData.append(int.from_bytes(data[2:4],'little')*0.087890625)
        self.left_knee_line.setData(self.l_kneeData)
        self.l_ankData.popleft()
        self.l_ankData.append(int.from_bytes(data[4:6],'little')*0.087890625)
        self.left_ankle_line.setData(self.l_ankData)
        

        self.r_hipData.popleft()
        self.r_hipData.append(int.from_bytes(data[6:8],'little')*0.087890625)
        self.right_hip_line.setData(self.r_hipData)
        self.r_kneeData.popleft()
        self.r_kneeData.append(int.from_bytes(data[8:10],'little')*0.087890625)
        self.right_knee_line.setData(self.r_kneeData)
        self.r_ankData.popleft()
        self.r_ankData.append(int.from_bytes(data[10:12],'little')*0.087890625)
        self.right_ankle_line.setData(self.r_ankData)
...
class PlotPressureWindow(QWidget):
    def __init__(self,parent=None):
        ...
        self.left_kneePre_plot.setYRange(0,5)
        ...
        self.left_anklePre_plot.setYRange(0,5)
        ...
        self.right_kneePre_plot.setYRange(0,5)
        ...
        self.right_anklePre_plot.setYRange(0,5)
    ...
    def UpdateData(self,data):
        ...
        self.l_knePreData.append(int.from_bytes(data[0:2],'little')/13107)
        self.left_kneePre_line.setData(self.l_knePreData)
        self.l_ankPreData.popleft()
        self.l_ankPreData.append(int.from_bytes(data[2:4],'little')/13107)
        self.left_anklePre_line.setData(self.l_ankPreData)
        self.r_knePreData.popleft()
        self.r_knePreData.append(int.from_bytes(data[4:6],'little')/13107)
        self.right_kneePre_line.setData(self.r_knePreData)
        self.r_ankPreData.popleft()
        self.r_ankPreData.append(int.from_bytes(data[6:8],'little')/13107)
