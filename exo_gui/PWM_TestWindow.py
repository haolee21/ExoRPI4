...
class PWM_TestWindow(QWidget):
    def __init__(self,parent=None):
        ...
        self.btn_LKneAnkDuty_start.clicked.connect(partial(self.DutyStartClicked,RKNE_LANK_PWM,self.LKneAnk_duty))
        ...
        self.btn_RKneAnkDuty_start.clicked.connect(partial(self.DutyStartClicked,LKNE_RANK_PWM,self.RKneAnk_duty))
        ...
        self.btn_LKneAnkDuty_stop.clicked.connect(partial(self.DutyStopClicked,RKNE_LANK_PWM))
        ...
        self.btn_RKneAnkDuty_stop.clicked.connect(partial(self.DutyStopClicked,LKNE_RANK_PWM))
