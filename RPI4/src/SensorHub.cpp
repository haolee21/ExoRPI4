...
SensorHub::SensorHub() //initialize member in list since Encoder has no default constructor
    ...
    ,PreRecorder("Pressure","Time,LTankPre,LKneExtPre,Force,Pos,TankPre,LKneFlexPre,na,na")
    ,PreRecOri("Pressure_ori","Time,LTankPre,LKneExtPre,Force,Pos,TankPre,LKneFlexPre,na,na")
