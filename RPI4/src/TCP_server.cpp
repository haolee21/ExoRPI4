...
//                 {
//                     const std::array<bool, (unsigned)Valves_hub::Joint::kTotal> con_enable = Valves_hub::GetControlCond();
//                     TCP_server::Send_cmd(std::string(con_enable.begin(), con_enable.end()), socket);
//                 }
//             }
//         }
...
//                 if (cmd_device.compare("LKNE_EXT") == 0)
//                 {
//                     Valves_hub::SetDuty(input, PWM_ID::kLKneExt);
//                     TCP_server::Send_cmd(std::string("1"), socket);
                    
//                 }
//                 else if (cmd_device.compare("LKNE_FLEX") == 0)
//                 {
//                     Valves_hub::SetDuty(input, PWM_ID::kLKneFlex);
//                     TCP_server::Send_cmd(std::string("1"), socket);
//                 }
//                 else if (cmd_device.compare("LANK_EXT") == 0)
//                 {
//                     Valves_hub::SetDuty(input, PWM_ID::kLAnkExt);
//                     TCP_server::Send_cmd(std::string("1"), socket);
//                 }
//                 else if (cmd_device.compare("LTANK") == 0)
//                 {
//                     Valves_hub::SetDuty(input, PWM_ID::kLTank);
//                     TCP_server::Send_cmd(std::string("1"), socket);
//                 }
//                 else if (cmd_device.compare("RKNE_EXT") == 0)
//                 {
//                     Valves_hub::SetDuty(input, PWM_ID::kRKneExt);
//                     TCP_server::Send_cmd(std::string("1"), socket);
//                 }
//                 else if (cmd_device.compare("RKNE_FLEX") == 0)
//                 {
//                     Valves_hub::SetDuty(input, PWM_ID::kRKneFlex);
//                     TCP_server::Send_cmd(std::string("1"), socket);
//                 }
//                 else if (cmd_device.compare("RANK_EXT") == 0)
//                 {
//                     Valves_hub::SetDuty(input, PWM_ID::kRAnkExt);
//                     TCP_server::Send_cmd(std::string("1"), socket);
//                 }
...
//                 {
//                     Valves_hub::SetDuty(input, PWM_ID::kRTank);
//                     TCP_server::Send_cmd(std::string("1"), socket);
//                 }
//                 else
//                 {
...
//                 {
//                     Valves_hub::SetDesiredPre(Valves_hub::Chamber::kLTank, pre_val);
//                     Valves_hub::EnableCon(Valves_hub::Joint::kLKne,JointCon::ControlMode::kPreConTank);
//                     TCP_server::Send_cmd(std::string("1"), socket);
//                 }
//                 else if(cmd_device.compare("LKNE_EXT")==0){
//                     Valves_hub::SetDesiredPre(Valves_hub::Chamber::kLKneExt,pre_val);
...
//     }
//     else
//     { // recursive so we don't need to write another function to check byte_transferred
//         socket->async_send(
